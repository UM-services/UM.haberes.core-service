...
def generate_wiki_content(wiki_dir: Path, data_dir: Path):
    ...
    try:
        ...
        with open(wiki_dir / 'Home.md', 'w', encoding='utf-8') as f:
            f.write("""# UM Tesorería Haberes Service Wiki

Bienvenido a la Wiki del servicio de Haberes de UM Tesorería.
...
""")
        ...
        with open(wiki_dir / 'Milestones.md', 'w', encoding='utf-8') as f:
            f.write("# Milestones del Servicio de Haberes\n\n")
        ...
        with open(wiki_dir / 'Issues-Activos.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Activos - Servicio de Haberes\n\n")
        ...
        with open(wiki_dir / 'Issues-Cerrados.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Cerrados - Servicio de Haberes\n\n")
        ...
        print(f"Error escribiendo archivos de la wiki del Servicio de Haberes: {e}")
        return False
