...
import ar.edu.um.haberes.rest.exception.CargoLiquidacionNotFoundException;
...
import ar.edu.um.haberes.rest.service.view.CargoLiquidacionPeriodoService;
...
public class CargoLiquidacionController {
	...
	public ResponseEntity<List<CargoLiquidacionPeriodo>> findAllRestoByLegajo(@PathVariable Long legajoId,
		...
		return new ResponseEntity<List<CargoLiquidacionPeriodo>>(
