...
public interface GetCargoLiquidacionesNoDocentesByLegajoUseCase {

    List<CargoLiquidacion> getCargosNoDocentesByLegajo(Long legajoId, Integer anho, Integer mes);
}
