...
public interface GetCargosNoDocentesByLegajoAndFacultadUseCase {

    List<CargoLiquidacion> getCargosNoDocentesByLegajoAndFacultad(Long legajoId, Integer anho, Integer mes,
            Integer facultadId);
}
