...
public interface GetLiquidacionesByAnhoAndMesBetweenUseCase {

    List<Liquidacion> getLiquidacionesByAnhoAndMesBetween(Integer anho, Integer mesDesde, Integer mesHasta);
}
