...
public class DeleteCargosNoDocentesByLegajoUseCaseImpl implements DeleteCargosNoDocentesByLegajoUseCase {
    ...
    @Transactional
    @Override
    public void deleteCargosNoDocentesByLegajo(Long legajoId, Integer anho, Integer mes) {
