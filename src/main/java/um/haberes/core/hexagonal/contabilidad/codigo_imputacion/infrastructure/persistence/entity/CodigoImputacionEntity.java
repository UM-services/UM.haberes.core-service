package um.haberes.core.hexagonal.contabilidad.codigo_imputacion.infrastructure.persistence.entity;
...
@Entity
@Table(name = "codigo_imputacion", uniqueConstraints = {
...
@NoArgsConstructor
@AllArgsConstructor
public class CodigoImputacionEntity extends AuditableEntity {
