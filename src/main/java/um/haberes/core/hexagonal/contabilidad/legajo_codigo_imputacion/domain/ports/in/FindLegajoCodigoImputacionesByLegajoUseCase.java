...
public interface FindLegajoCodigoImputacionesByLegajoUseCase {

    List<LegajoCodigoImputacion> findLegajoCodigoImputacionesByLegajo(Long legajoId, Integer anho, Integer mes);
}
