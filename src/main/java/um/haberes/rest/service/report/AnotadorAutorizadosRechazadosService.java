...
public class AnotadorAutorizadosRechazadosService {
    ...
    public AnotadorAutorizadosRechazadosService(Environment environment, AnotadorService anotadorService) {
    ...
    private void generateReport(String filename, Integer facultadId, Integer anho, Integer mes) {
        ...
        try {
            ...
            for (Anotador anotador : anotadorService.findAutorizadosByFacultad(facultadId, anho, mes)) {
            ...
            for (Anotador anotador : anotadorService.findRechazadosByFacultad(facultadId, anho, mes)) {
                addAnotadorDetails(document, anotador);
            }
